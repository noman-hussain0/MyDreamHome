...
function sendArchitectEmail($data) {
    ...
    $to = $data['email'];
    $subject = "Architect Application - " . htmlspecialchars($data['full_name']);
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Architect Application Received</h1>
                <p>Thank you for your interest!</p>
            </div>
            
            <div class="content">
                <h2>Hello ' . htmlspecialchars($data['full_name']) . ',</h2>
                <p>Your architect application has been received successfully. Here are the details:</p>
                ...
                <div class="detail-row">
                    ...
                    <div class="value">' . htmlspecialchars($data['experience'] ?: 'Not specified') . '</div>
                </div>
                <div class="detail-row">
                    <div class="label">COA Registered</div>
                    <div class="value">' . htmlspecialchars($data['coa_registered'] ?: 'Not specified') . '</div>
                </div>
    ...
    try {
        ...
        $mail->Body    = $message;
        $mail->AltBody = "Thank you for your architect application.";
