...
<footer class="bg-[#111] text-[#aaa] px-6 md:px-12 xl:px-32 pt-12 pb-7 w-full">
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 max-w-7xl mx-auto">
        <div class="col-span-2 md:col-span-1">
            ...
            <p class="text-sm leading-relaxed">B.Tech (Civil), M.Tech (Structures)</p>
            <p class="text-sm leading-relaxed">GHMC Licensed Structural Engineer</p>
            <p class="text-sm leading-relaxed">License No. 463/strl, Engineer/TPS/GHMC</p>
